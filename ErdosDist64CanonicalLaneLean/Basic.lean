/-!
# erdos-dist-64 Lean migration boundary
...
`erdos_dist_64/SourcePackage.lean`.
...
def sourceRepository : String := "erdos-dist-64"
def sourceUrl : String := "https://github.com/HautevilleHouse/erdos-dist-64"
def sourceDescription : String := "Canonical-lane closure package for the Erdős Distinct Distances (n=64): admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["erdos-dist-64", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
