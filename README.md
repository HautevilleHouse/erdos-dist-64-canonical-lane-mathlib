# Erdős Distinct Distances (n=64) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Erdős Distinct Distances (n=64).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/erdos-dist-64-mathlib.git
cd erdos-dist-64-mathlib
lake exe
lake build
```
